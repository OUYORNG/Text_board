      ...
      <div class="operate ">
        ...
        <div class="scrollDirection bg-white flex justify-between p-2 rounded-md mt-2">
          <div class="left flex justify-center items-center gap-2 font-bold">
            <svg
              class="bg-[#529EE4] p-1 rounded-xl text-white w-9"
          ...
          <div class="right flex justify-center items-center gap-2 "></div>
        </div>
        {/* <!-- Scroll Speed --> */}
        <div class="scrollDirection bg-white flex justify-between p-2 rounded-md mt-2">
          <div class="left flex justify-center items-center gap-2 font-bold">
          ...
          <div class="right flex justify-center items-center gap-2 ">
            <button class="righ btn left btn-light ">-</button>
            <button class="righ btn left btn-light ">+</button>
          </div>
        </div>
        {/* <!-- Blink ON OFF --> */}
        <div class="scrollDirection bg-white flex justify-between p-2 rounded-md mt-2">
          ...
          <div class="right flex justify-center items-center gap-2  ">
            <input class="w-[153px] rounded-xl bg-re" type="color" />
          </div>
        </div>
        {/* <!-- Blink Frequency --> */}
        <div class="scrollDirection bg-white flex justify-between p-2 rounded-md mt-2">
