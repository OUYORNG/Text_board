<template>
    <div class="m-3  rounded-md bg-[#71A8FB] " >
        <div class="Nav flex-grow flex justify-between items-center pl-8 pr-8 pt-2 pb-2 md:pl-4 md:pr-4 ">   
            <img class="w-[60px] h-[45px] rounded-sm" src="./Img/image.png"/>  
            <div class="about md:gap-8 md:flex hidden">
                <a style="text-decoration: none;" href="" class="Home hover:text-white text-inherit">HOME</a>
                <a style="text-decoration: none;" href="" class="about hover:text-white text-inherit">ABOUT US</a>
                <a style="text-decoration: none;" href="" class="contact hover:text-white text-inherit">CONTACTS</a>
            </div>
