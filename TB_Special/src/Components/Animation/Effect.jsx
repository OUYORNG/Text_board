...
// }
function resize() {
	const div = document.getElementById('yourDivId'); // Replace 'yourDivId' with the actual id of your div
	const { clientWidth, clientHeight } = div;
	
	canvas.a.width = clientWidth;
    canvas.a.height = 290; // Assuming the height for canvas.a remains fixed

    ctx.a.drawImage(canvas.b, 0, 0);

	canvas.b.width = clientWidth;
    canvas.b.height = clientHeight;
